...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>联系邮箱</label>
										<input id="lianxiyouxiang" name="lianxiyouxiang" class="form-control" placeholder="联系邮箱">
									</div>
									<div class="form-group col-md-6">
										<label>身份证号</label>
										<input id="shenfenzhenghao" name="shenfenzhenghao" class="form-control" placeholder="身份证号">
									</div>
									<div class="form-group col-md-6">
										<label>照片</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#lianxiyouxiang").val(ruleForm.lianxiyouxiang);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.lianxiyouxiang != null && res.data.lianxiyouxiang != ''){

					$("#lianxiyouxiang").val(res.data.lianxiyouxiang);
					}
