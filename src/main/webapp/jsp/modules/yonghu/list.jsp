...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('lianxiyouxiang')">联系邮箱<i id="lianxiyouxiangIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var lianxiyouxiangCell  = document.createElement('td');

						 lianxiyouxiangCell.innerHTML = item.lianxiyouxiang;


			row.appendChild(lianxiyouxiangCell);
