						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="lianxiyouxiang" name="lianxiyouxiang" class="form-control" v-model="ruleForm.lianxiyouxiang" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>身份证号</label>

									<input id="shenfenzhenghao" name="shenfenzhenghao" class="form-control" v-model="ruleForm.shenfenzhenghao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>照片</label>
