		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.shangpinzhonglei" type="text" name="shangpinzhonglei" id="shangpinzhonglei" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">商品图片：</label>
						<div v-if="detail.shangpintupian" class="layui-input-block">
							<img id="shangpintupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="detail.shangpintupian">
						...
						<div class="layui-input-block">
							<input v-model="detail.shangpinjiage" type="text" name="shangpinjiage" id="shangpinjiage" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">规格：</label>
						<div class="layui-input-block">
							<input v-model="detail.guige" type="text" name="guige" id="guige" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                            ...
                                                            if(!isIntNumer(data.shangpinjiage)){
                        layer.msg('商品价格应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('jianshenshangpin' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
