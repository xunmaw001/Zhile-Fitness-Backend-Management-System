				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.wenzhangneirong"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`jianshenzhishi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.wenzhangbiaoti;
																														// 轮播图片
					vue.swiperList = vue.detail.tupianfengmian ? vue.detail.tupianfengmian.split(",") : [];
																																													var swiperItemHtml = '';
