				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>健身类型：</span>
							<span class="desc">
								{{detail.jianshenleixing}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>教练工号：</span>
							<span class="desc">
								{{detail.jiaoliangonghao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>教练姓名：</span>
							...
							<span>上课时间：</span>
							<span class="desc">
								{{detail.shangkeshijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>上课地点：</span>
							<span class="desc">
								{{detail.shangkedidian}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>课程费用：</span>
							<span class="desc">
								{{detail.kechengfeiyong}}
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('jianshenkecheng','购买')" @click="onAcrossTap('kechenggoumai')" type="button" class="layui-btn">
								购买
							</button>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.kechengmingcheng;
																														// 轮播图片
